...
from decoder_sampling import sample_next_token
...
def sampling(svae_encoder, svae_decoder, gvae_encoder, X_adj, X_features, max_length, prime_str='!', end_token='E'):
	...
	for p in range(max_length):
		...
		top_i = sample_next_token(probs)  # multinomial or greedy — see reward_config / decoder_sampling
...
def run_training():
	...
	print("  (edit reward_config.py or Sample_index.txt: reward_<name>, weights, use_arithmetic_mean, use_multinomial_sampling)")
