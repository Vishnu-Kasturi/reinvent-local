...
if not files:
    print("No TL run3 checkpoint sample files found!"); sys.exit(1)
...
fig.suptitle('PD1-PDL1 TL Run3 Epoch Progressions vs pIC50 Processed Baseline\n(logS from solubility model)', 
...
plt.tight_layout()
outpath = 'results/pd1_pdl1_tl_run3_epoch_kde_vs_pic50_baseline.png'
