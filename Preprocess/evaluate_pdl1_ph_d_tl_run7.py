#!/usr/bin/env python3
"""
evaluate_pdl1_ph_d_tl_run7.py
==============================
Samples 500 molecules from every 10-epoch checkpoint of pdl1_ph_d_tl_run7.model (up to 150 epochs).
Run7: freeze_n_layers=0, lr=5e-5, internal_diversity=True
"""
...
N_SAMPLE   = 500
MODEL_STEM = "pdl1_ph_d_tl_run7"
RUN_LABEL  = "pdl1_ph_d TL run7 (freeze_n_layers=0, int_div=T, lr=5e-5, 150ep)"
...
def sample_checkpoint(chkpt_path, epoch):
    ...
    if os.path.exists(out_csv):
        ...
        return out_csv
    toml_path = os.path.join(CONFIGS_DIR, f"_ph_d_tl_run7_sample_e{epoch}.toml")
    with open(toml_path, "w") as f:
        f.write(f"""run_type = "sampling"
device   = "mps"
json_out_config = "_ph_d_tl_run7_sample_e{epoch}.json"
