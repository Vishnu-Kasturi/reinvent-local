#!/usr/bin/env python3
"""
evaluate_pdl1_ph_d_tl_run4.py
==============================
Samples 500 molecules from every 10-epoch checkpoint of pdl1_ph_d_tl_run4.model,
produces Tanimoto histograms and KDE property plots vs. filtered_smiles_tanimoto.
Run4: freeze_n_layers=2, lr=1e-4.
"""
...
N_SAMPLE   = 500
MODEL_STEM = "pdl1_ph_d_tl_run4"
RUN_LABEL  = "pdl1_ph_d TL run4 (freeze_n_layers=2, lr=1e-4)"
...
def sample_checkpoint(chkpt_path, epoch):
    ...
    if os.path.exists(out_csv):
        ...
        return out_csv
    toml_path = os.path.join(CONFIGS_DIR, f"_ph_d_tl_run4_sample_e{epoch}.toml")
    with open(toml_path, "w") as f:
        f.write(f"""run_type = "sampling"
device   = "mps"
json_out_config = "_ph_d_tl_run4_sample_e{epoch}.json"
